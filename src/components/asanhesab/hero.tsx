...
import { Zap, Clock, Shield, Headphones, Monitor, Play, Check } from "lucide-react";
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 pb-20 sm:pt-16 sm:pb-28 lg:pt-20 lg:pb-32">
        <div className="flex flex-col items-center text-center">
          ...
          <h1
            id="hero-headline"
            className="mt-6 text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.25] sm:leading-[1.2] max-w-4xl animate-soft-fade-up"
          ...
          {/* Sub-headline */}
          <p
            className="mt-5 sm:mt-6 text-base sm:text-lg lg:text-xl text-slate-600 leading-relaxed max-w-2xl animate-soft-fade-up"
          ...
          {/* CTAs */}
          <div
            className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto animate-soft-fade-up"
          ...
          <ul
            className="mt-10 sm:mt-12 grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3 w-full max-w-3xl animate-soft-fade-up"
        ...
        <div
          className="relative mt-16 sm:mt-20 lg:mt-24 animate-soft-fade-up"
